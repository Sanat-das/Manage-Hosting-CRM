...
@section('content_header')
    <x-ui.page-header title="Edit {{ $gateway->name }}" subtitle="Update gateway configuration and credentials" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')], ['label' => 'Gateway Settings', 'url' => route('admin.gateway-settings.index')], ['label' => $gateway->name, 'active' => true]]" />
@stop
