...
@section('content_header')
    <x-ui.page-header title="About & Updates" subtitle="View system information and updates" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')],['label' => 'About & Updates','active' => true]]" />
@stop
