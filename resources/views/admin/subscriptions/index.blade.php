...
@section('content_header')
    <x-ui.page-header title="Subscriptions" subtitle="Browse and manage recurring subscriptions" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')], ['label' => 'Subscriptions', 'active' => true]]" />
@stop
