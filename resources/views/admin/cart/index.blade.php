...
@section('content_header')
    <x-ui.page-header title="Shopping Cart" subtitle="Browse and manage cart products" :breadcrumbs="[
                    ...
                    @foreach ($categories as $cat)
                        <li class="nav-item">
                            <a class="nav-link" href="#cat-{{ $cat->id }}">
                                ...
                                <span class="badge text-bg-primary float-end">{{ $cat->catalogProducts->count() }}</span>
                            </a>
                        </li>
                    @endforeach
                </ul>
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card h-100 border">
                                    <div class="card-body">
                                        ...
                                        <span class="badge text-bg-secondary">{{ ucfirst(str_replace('_', ' ', $product->billing_cycle ?? 'monthly')) }}</span>
