...
@section('content_header')
    <x-ui.page-header title="{{ $product->name }}" subtitle="View product details and pricing" :breadcrumbs="[
        ...
        <div class="col-md-8">
            <x-adminlte-card icon="bi bi-box-seam" title="{{ $product->name }}">
                ...
                <div class="mb-2">
                    ...
                    <span class="badge text-bg-primary">From ₹{{ number_format($product->price, 2) }}</span>
                </div>
