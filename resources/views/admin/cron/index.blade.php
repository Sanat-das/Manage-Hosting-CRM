...
@section('content_header')
    <x-ui.page-header title="Cron Jobs" subtitle="Overview and management of scheduled jobs" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')],['label' => 'Cron Jobs','active' => true]]" />
@stop
