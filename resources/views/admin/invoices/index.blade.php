...
@section('content_header')
    <x-ui.page-header title="Invoices" subtitle="Browse and manage all invoices and billing" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')], ['label' => 'Invoices', 'active' => true]]" />
@stop
