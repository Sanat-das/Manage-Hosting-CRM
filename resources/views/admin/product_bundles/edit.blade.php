...
@section('content_header')
    <x-ui.page-header title="Edit: {{ $bundle->name }}" subtitle="Update product bundle details" :breadcrumbs="[
        ['label' => __('adminlte.home'), 'url' => url('/')],
        ['label' => 'Product Bundles', 'url' => route('admin.product-bundles.index')],
        ['label' => $bundle->name, 'url' => route('admin.product-bundles.show', $bundle)],
