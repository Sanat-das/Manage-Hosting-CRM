...
@section('content')
    ...
    <x-adminlte.partials.datatable icon="bi bi-globe" title="All Domains"
        ...
        :columns="[
            ['label' => 'Domain', 'sort' => 'domain'], ['label' => 'Customer', 'sort' => 'customer'], ['label' => 'Registrar', 'sort' => 'registrar'],
            ['label' => 'Expiry', 'sort' => 'expires_at'], ['label' => 'Auto-renew', 'sort' => 'auto_renew'],
            ['label' => 'Status', 'sort' => 'status'], ['label' => 'Actions', 'class' => 'text-end'],
        ]" :pagination="$domains">
        <x-slot name="tools">
            @can('domains.manage')
            ...
            <tr>
                ...
                <td class="text-end">
                        <div class="table-actions">
                            @can('domains.manage')
                            <a href="{{ route('admin.domains.edit', $domain) }}" class="btn btn-sm btn-outline-secondary btn-icon" title="Edit" aria-label="Edit"><i class="bi bi-pencil"></i></a>
                            @endcan
                        </div>
                    </td>
            </tr>
