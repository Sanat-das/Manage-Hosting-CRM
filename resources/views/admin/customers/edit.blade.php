...
@section('content')
    ...
    >
        ...
        <div class="border rounded p-3 mb-3 bg-light-subtle">
            ...
            <div class="row">
                <div class="col-md-6">
                    {{-- autocomplete="off": this is the customer's address, not the
                         admin's. See customers/create for the failure it prevents. --}}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <x-state-field autocomplete="off" :value="$customer->user?->state" :country="$customer->user?->country" />
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    <x-country-select autocomplete="off" :selected="$customer->user?->country" />
                </div>
