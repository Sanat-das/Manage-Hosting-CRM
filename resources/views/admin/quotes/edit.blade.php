...
@section('content_header')
    <x-ui.page-header title="Edit Quote" subtitle="Update quote details and pricing" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')], ['label' => 'Quotes', 'url' => route('admin.quotes.index')], ['label' => $quote->quote_no, 'active' => true]]" />
@stop
