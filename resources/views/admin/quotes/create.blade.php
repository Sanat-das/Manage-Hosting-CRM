...
@section('content_header')
    <x-ui.page-header title="New Quote" subtitle="Create a new quote for your customer" :breadcrumbs="[['label' => __('adminlte.home'), 'url' => url('/')], ['label' => 'Quotes', 'url' => route('admin.quotes.index')], ['label' => 'New', 'active' => true]]" />
@stop
