...
namespace App\Contracts\Integrations\Capabilities;
 ...
 * treated as non-provisioning. $config is the ALREADY-DECRYPTED integration
 * config, passed through by the manager.
 */
