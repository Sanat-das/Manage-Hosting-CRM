...
@section('auth_body')
    <header class="auth-head">
        <p class="auth-head__eyebrow">Client Portal</p>
        <h1 class="auth-head__title">{{ __('Sign in to manage your services') }}</h1>
    </header>
    ...
    @endif
    <p class="auth-alt">
        <a href="{{ route('admin.login') }}" class="auth-link">{{ __('Staff login') }}</a>
    </p>
@endsection