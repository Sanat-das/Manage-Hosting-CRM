    ...
    <x-adminlte-card icon="bi bi-box-seam" title="All Assets">
        <div class="row mb-3">
            <div class="col-md-8">
                <form method="GET" action="{{ route('admin.inventory-assets.index') }}" class="d-flex gap-2 flex-wrap">
                    <x-adminlte-input name="search" placeholder="Search tag, serial, model..." value="{{ request('search') }}" fgroup-class="flex-grow-1" />
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead><tr><th>Asset Tag</th><th>Type</th><th>Serial</th><th>Model</th><th>Datacenter</th><th>Rack</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
                <tbody>
