...
@section('content_header')
    <div class="row"><div class="col-sm-6"><h1 class="m-0">Edit Upgrade Path</h1></div>
        <div class="col-sm-6"><ol class="breadcrumb float-sm-end"><li class="breadcrumb-item"><a href="{{ url('/') }}">{{ __('adminlte.home') }}</a></li><li class="breadcrumb-item"><a href="{{ route('admin.product-upgrades.index') }}">Product Upgrade Paths</a></li><li class="breadcrumb-item active">Edit</li></ol></div></div>
@stop
@section('content')
