...
@section('content')
    ...
    <x-adminlte-card icon="bi bi-building" title="All Datacenters">
        <div class="text-end mb-3"><a href="{{ route('admin.datacenters.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg me-1"></i> Add Datacenter</a></div>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead><tr><th>Name</th><th>Code</th><th>Location</th><th>Racks</th><th>Status</th><th class="text-end">Actions</th></tr></thead>
                <tbody>
                    @forelse ($datacenters as $dc)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.datacenters.edit', $dc) }}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-pencil"></i></a>
                            </td>
                        </tr>
                    @empty
