...
export interface AudioEngineLib {
    ...
    audioLoad: (engine: Pointer, data: Uint8Array) => {
        status: number;
        soundId: number | null;
    };
    audioUnload: (engine: Pointer, soundId: number) => number;
    audioPlay: (engine: Pointer, soundId: number, options?: AudioVoiceOptions) => {
        status: number;
        voiceId: number | null;
    };
    ...
    audioCreateGroup: (engine: Pointer, name: string) => {
        status: number;
        groupId: number | null;
    };
    ...
    audioReadTap: (engine: Pointer, outBuffer: Float32Array, frameCount: number, channels: number) => {
        status: number;
        framesRead: number;
    };
