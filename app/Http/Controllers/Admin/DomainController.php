...
class DomainController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $statuses = array_combine(DomainService::STATUSES, DomainService::STATUSES);
    ...
    public function search(Request $request): View
    {
        ...
        if ($query !== '') {
            $results = $this->domains->searchAvailability($query);
        }

        return view('admin.domains.search', compact('query', 'results'));
    }
}
