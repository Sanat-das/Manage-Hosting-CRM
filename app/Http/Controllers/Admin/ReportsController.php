...
class ReportsController extends Controller
{
    ...
    public function sales(Request $request): View
    {
        ...
        $orders = \App\Models\Order::whereBetween('created_at', [$from, $to])
            ->with('customer')
        ...
        $orderCount = \App\Models\Order::whereBetween('created_at', [$from, $to])->count();
    ...
    private function exportOrders($handle, string $from, string $to): void
    {
        ...
        \App\Models\Order::whereBetween('created_at', [$from, $to])
            ->with('customer')
            ->orderByDesc('created_at')
