...
class InstallerService
{
    ...
    public function run(array $input): void
    {
        ...
        // 7. Mark the application as installed and refresh cached config so
        //    the next request boots as a fully installed application.
    ...
    private function verifyConnection(
        ...
        if ($exists === false) {
            throw new RuntimeException(
                'The database "'.$database.'" does not exist on the server. '
                .'Create it first, e.g.: CREATE DATABASE `'.$database.'` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;'
            );
        }
    }
