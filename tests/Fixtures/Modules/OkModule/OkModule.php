...
/**
 * Healthy fixture module used by the module-system feature tests.
 *
 * Lives under tests/Fixtures/Modules/ so composer's autoload-dev mapping
 * (Tests\ => tests/) loads it without any runtime autoloader.
 */
