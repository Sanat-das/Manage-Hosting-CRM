 ...
 *
 * - Captures the 189 name="settings[*]" keys rendered by
 *   resources/views/admin/settings/index.blade.php (84 baseline + 94 task-8 typed
 *   surfaced + 11 imap_* for ticket email piping)
...
class AdminSettingsInventoryTest extends TestCase
{
    ...
    /**
     * Baseline set - 189 keys rendered by admin/settings/index.blade.php (84 + 94 typed + 11 imap).
    ...
    public function test_baseline_field_inventory_is_unchanged(): void
    {
        ...
        $this->assertCount(189, $keys, 'Baseline field count changed - expected 189 name="settings[*]" keys. Got: ' . implode(', ', $keys));
    ...
    {
        // 1 legacy settings pluck + 16 typed group loads (distinct classes in AppSettings::TYPED_KEYS) = 17.
        ...
        $this->assertLessThanOrEqual(
            17,
            $settingCount,
            "GET admin.settings.index issued {$settingCount} setting queries (expected <=17 = 1 pluck + 16 typed groups). "
