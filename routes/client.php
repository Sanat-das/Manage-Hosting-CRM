...
Route::middleware(['web', 'auth', 'client', 'customer.record'])->prefix('client')->name('client.')->group(function () {
    ...
    Route::post('domains/register', [DomainController::class, 'registerStore'])->name('domains.register.post');
...
Route::get('tickets/{id}/attachments/{attachment}', [TicketController::class, 'showAttachment'])->name('tickets.attachments.show');
    ...
    Route::post('profile/consent', [ProfileController::class, 'toggleConsent'])->name('profile.consent');
