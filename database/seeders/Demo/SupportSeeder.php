 ...
 * - ticket.status          open|answered|customer_reply|on_hold|in_progress|closed
...
class SupportSeeder extends Seeder
{
    ...
    private const TICKET_STATUSES = ['open', 'answered', 'customer_reply', 'on_hold', 'in_progress', 'closed'];
